...
with open(TOUIDX,'r') as f:
  for row in f.readlines():
    ...
    # do stuff here 
      ...
      template = "An exception of type {0} occured. TOUFILE: {1}"
      message = template.format(type(ex).__name__, TOUNAME)
      print message # will print to screen for now; can redirect this to a file
